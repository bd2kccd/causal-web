        ...
        <div id="wrapper">
            <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="${path}/${path}/${path}/home">${ccd.title}</a>
                </div>
            ...
            <div id="page-wrapper">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="resumable-error">Your browser, unfortunately, is not supported by Resumable.js. The library requires support for <a href="${path}/http://www.w3.org/TR/FileAPI/">the HTML5 File API</a> along with <a href="${path}/http://www.w3.org/TR/FileAPI/#normalization-of-params">file slicing</a>.</div>
