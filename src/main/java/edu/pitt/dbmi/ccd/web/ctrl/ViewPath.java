...
public interface ViewPath {
    ...
    public static final String ALGORITHM_COMPARE_VIEW = "algorithm/algorithmCompare";

    public static final String REDIRECT_CLOUD_ALGORITHM_RESULTS = "redirect:/cloud/algorithm/results";
