...
import edu.pitt.dbmi.ccd.web.service.file.NewUploadFileService;
...
public class NewUploadFileController implements ViewPath {
    ...
    @Autowired
    public NewUploadFileController(NewUploadFileService newUploadFileService) {
        this.newUploadFileService = newUploadFileService;
    }

    @RequestMapping(method = RequestMethod.GET)
    public String showFiles(AppUser appUser, Model model) {
        newUploadFileService.listFiles(appUser, model);
    ...
    public String showFileInfo(
            ...
            final Model model) {
        newUploadFileService.showFileInfo(id, appUser, model);
