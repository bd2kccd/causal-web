...
/**
 *
 * Jul 25, 2016 4:55:28 PM
 *
 * @author Kevin V. Bui (kvb2@pitt.edu)
 */
@Service
public class DataInputFileService {
    ...
    @Autowired
    public DataInputFileService(UserAccountService userAccountService, FileManagementService fileManagementService, FileService fileService, FileTypeService fileTypeService) {
    ...
    public void listFiles(AppUser appUser, Model model) {
        ...
        fileManagementService.syncDatabaseWithDirectory(dataFileType, userAccount);

        model.addAttribute("pageTitle", "Data Files");
        model.addAttribute("itemList", fileService.findByFileTypeAndUserAccount(dataFileType, userAccount));
    }
