...
/**
 *
 * Jul 25, 2016 6:09:17 PM
 *
 * @author Kevin V. Bui (kvb2@pitt.edu)
 */
@Service
public class AlgorithmResultFileService {
    ...
    @Autowired
    public AlgorithmResultFileService(UserAccountService userAccountService, FileManagementService fileManagementService, FileService fileService) {
