...
/**
 *
 * Jul 9, 2016 10:18:22 PM
 *
 * @author Kevin V. Bui (kvb2@pitt.edu)
 */
public class CategorizeFile {

    @NotNull(message = "File type ID is required.")
    private Long fileTypeId;

    @NotNull(message = "File delimiter ID is required.")
    private Long fileDelimiterId;

    @NotNull(message = "Variable type ID is required.")
    private Long variableTypeId;

    public CategorizeFile() {
    }
