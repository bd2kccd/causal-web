 ...
 */
@Service
public class PriorKnowledgeFileService {

    private static final Logger LOGGER = LoggerFactory.getLogger(PriorKnowledgeFileService.class);
    ...
    @Autowired
    public PriorKnowledgeFileService(UserAccountService userAccountService, FileManagementService fileManagementService, FileService fileService) {
    ...
    public void listFiles(AppUser appUser, Model model) {
        ...
        FileType fileType = fileManagementService.findByFileTypeEnum(FileTypeEnum.PRIOR_KNOWLEDGE);
