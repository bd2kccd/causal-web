...
/**
 *
 * Jul 25, 2016 5:31:12 PM
 *
 * @author Kevin V. Bui (kvb2@pitt.edu)
 */
@Service
public class DataVariableFileService {
    ...
    @Autowired
    public DataVariableFileService(UserAccountService userAccountService, FileManagementService fileManagementService, FileService fileService) {
    ...
    public void listFiles(AppUser appUser, Model model) {
        ...
        FileType fileType = fileManagementService.findByFileTypeEnum(FileTypeEnum.VARIABLE);
