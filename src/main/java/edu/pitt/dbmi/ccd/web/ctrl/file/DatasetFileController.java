...
import edu.pitt.dbmi.ccd.web.service.file.DatasetFileService;
...
public class DatasetFileController implements ViewPath {
    ...
    public String showFiles(AppUser appUser, Model model) {
        datasetFileService.listFiles(appUser, model);
    ...
    public String showFileInfo(
            ...
            final Model model) {
        datasetFileService.showFileInfo(id, appUser, model);
